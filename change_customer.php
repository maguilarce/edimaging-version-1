...
if($pass1 == $pass2){
 ...
 $sql1="SELECT * FROM customer WHERE customer_name='$comp'";
 $res1=  mysql_query($sql1);
 $row1=  mysql_fetch_array($res1);
 
 if(!$row1)
 {    
     $new_comp="INSERT INTO customer (customer_name) VALUES ('$comp')";
     $res_comp=  mysql_query($new_comp);
     $query4 = "SELECT * from customer ORDER BY idcustomer desc limit 1";
     $res4 = mysql_query($query4);
     $row4 = mysql_fetch_array($res4);
     $idcus=$row4['idcustomer'];   
     $query = "UPDATE ucust
              SET c_password='$pass1',idcustomer='$idcus',f_name='$fname',l_name='$lname',c_email='$email', c_phone='$phone'
              WHERE c_login='$userid'";
