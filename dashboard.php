...
$latest_tickets= "SELECT * FROM ticket_history where 1 ORDER BY idticket_history desc limit 10";
$res= mysql_query($latest_tickets);
//$row= mysql_fetch_array($res);
$admin="SELECT * FROM administrator where 1 limit 10";
$res2= mysql_query($admin);
//$row2= mysql_fetch_array($res2);
$invent="SELECT * FROM inventory";
$res4= mysql_query($invent);
                            ...
                            <div class="panel">
                              ...
                              <tbody>
                                   ...
                                   while($row4 = mysql_fetch_array($res4)){
                                     echo "<tr><td>".$row4['dahill_id']." </td>   
                                     <td>".$row4['serial_number']."</td>
                                     <td>".$row4['model']."</td>
                                     <td>".$row4['customer']."</td>
                                     <td>".$row4['location']."</td>    
                                     <td><form action='inv_view.php' method='POST'> 
                                    <button class='btn btn-primary btn-sm btn-info' type='submit'>
                                     <i class='fa fa-view'></i>View</button>
                                     <input type='hidden' name='idinv' value='".$row4['idinventory']."'></td>
                                  </form><td><form action='' method='POST'> 
                                    <button class='btn btn-danger' type='submit'>
                                     <i class='fa fa-view'></i>Delete</button>
                                     <input type='hidden' name='idinv2' value='".$row4['idinventory']."'></td>
                                  </form>";
                                   } ?>
                              </tbody></table>
                                ...
                                <div class="panel-footer bg-white">
                                    ...
                                    <a href="new_inv.php" class="btn btn-primary btn-addon btn-sm"> Add Item</a> 
