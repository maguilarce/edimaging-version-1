...
$query = "SELECT * FROM administrator WHERE idadministrator ='$id'";
                                    ...
                                    while($row = mysql_fetch_array($res, MYSQL_ASSOC))
                                          {
                                           ...
                                           echo "<input type='hidden' name='userid' value=".$row['idadministrator'].">";
                                           echo "<tr>";
                                           echo "<td>{$row['admin_login']}</td>";
                                           echo "<td><input type='password' name='pass1' value='{$row['admin_password']}'></td>"; 
                                           echo "<td><input type='password' name='pass2' value='{$row['admin_password']}'></td>"; 
                                           echo "<td><input type='text' name='email' value='{$row['admin_email']}'></td>"; 
                                           echo "<td><button formaction='change_user.php' type='submit' class='btn btn-danger'>Apply Changes</button></td>";
                                           echo "</tr></form>";
                                          } 
                                    ?>
