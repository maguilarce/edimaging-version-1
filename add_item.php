...
session_start();
    ...
    $query = "INSERT INTO inventory (dahill_id, serial_number, model, customer, area, location)
              VALUES ('$dahill','$sn','$model', '$customer', '$area', '$location')";
                                ...
                                <section class="panel">
                                    <div class="panel-body">
                                        ...
                                        <div class="alert alert-success ">
                                            ...
                                            <strong>Well done!</strong> Item added satisfactorily.
                                        </div>
                                        <div>
